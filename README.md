...
A collaborative trading bot project built on top of Alpaca Trade API.

## Description

This project uses the Alpaca Trade API to implement automated trading strategies. It's built as a collaborative effort to develop and test various trading algorithms.
